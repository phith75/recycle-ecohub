...
channel.bind('userData', function(data) {
    ...
    alert("Cám ơn "+ data.userName +" đã đổ rác <3");
    location.reload();
          chart.render();
                            ...
                            <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 text-center">
                               <?php 
                                ...
                                <div class=" text-center">
                                    <h3 class="text-white">Tổng sức chứa: {{ $type->weight = isset($trash) ? $type->weight : 0 }} kg</h2>
                                </div>
                                <div class=" text-center">
                    ...
                    <form action="">
                        <div class=" align-items-center py-lg-8 py-6">
                                ...
                                <input style="background: #ffffff; border:none"
                                    class="mt-2 nav-link btn btn-light text-black m-auto w-75 h-50 w-lg-75"
                                    aria-current="page" id="trash-weight" placeholder="Số cân nặng rác" type="number">
                           
                                <select style="background: #ffffff; border:none"
                                    class="mt-2 nav-link btn btn-light text-black m-auto w-75 h-50 w-lg-75"
                                    aria-current="page" id="trash-type">
                                ...
                                <a style="background: #65e4a3; border:none"
                                    ...
                                    id="generate"><i class="fas fa-qrcode"></i> Quét mã</a>
...
generate.addEventListener('click', (e) => {
    ...
    if (selectedValue && enteredWeight && enteredWeight <= parseFloat('{{ $weightable }}')) {
        ...
        const errorSpan = document.querySelector('.validation-error')git remote add origin <URL_repository>;
        ...
        trashWeightInput.after(errorSpan);
    }
});
...
foreach ($trasheType as $type) {
    ...
    echo "<script>
        ...
        var chart = new ApexCharts(document.querySelector('#chart" . $type->id . "'), options);
        chart.render();
    </script>";
}
