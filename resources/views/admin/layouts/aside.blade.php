        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              ...
              <div data-i18n="Account Settings">Thùng rác</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('trash.index') }}" class="menu-link">
                  <div data-i18n="Account">Danh sách thùng rác</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{ route('type_trash.index') }}" class="menu-link">
                  <div data-i18n="Notifications">Loại rác</div>
                </a>
              </li>
